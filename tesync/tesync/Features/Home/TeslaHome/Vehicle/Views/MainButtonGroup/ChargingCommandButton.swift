...
struct ChargingCommandButton: View {
    ...
    var body: some View {
        Button(action: {
            ...
            HStack {
                if isLoading {
                    ...
                    Image(systemName: "ev.plug.dc.nacs").foregroundStyle(isCharging ? .green : .gray)
        ...
        .onAppear {
            if let chargeState = vehicle.chargeState, let chargingState = chargeState.chargingState {
